...
import Deber_03_07.Control.ActorControl;
 ...
 * @author Juano
 */
public class Ventana_Actor_Modificar extends JInternalFrame {
     ...
     */
    public Ventana_Actor_Modificar() {
        initComponents();
    ...
    private void initComponents() {
        ...
        jLabel10.setText("Codigo de la Pelicula:");
        ...
        jLabel11.setText("Datos a Modificar (Codigo)");
                            ...
                            .addGroup(jPanel1Layout.createSequentialGroup()
                                ...
                                .addGroup(jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                                    .addGroup(jPanel1Layout.createSequentialGroup()
                                        ...
                                        .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED)
                                        .addComponent(jRadioButton3, javax.swing.GroupLayout.DEFAULT_SIZE, 129, Short.MAX_VALUE))
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        if (JOptionPane.showConfirmDialog(this, "¿Modificar el actor?", "Seleccione una opción...", JOptionPane.YES_NO_CANCEL_OPTION, JOptionPane.QUESTION_MESSAGE) == 0) {
            ...
            try {
                this.actorControl.modificar(retorno);
    ...
    public void actualizarTabla() {
        ...
        var data = new Object[this.actorControl.Listar().size()][8];
        for (var i = 0; i < this.actorControl.Listar().size(); i++) {
            ...
            data[i][7] = this.actorControl.Listar().get(i).getPelicula().getNombrePelicula();
    ...
    public static void main(String args[]) {
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new Ventana_Actor_Modificar().setVisible(true);
            }
        });
    }
