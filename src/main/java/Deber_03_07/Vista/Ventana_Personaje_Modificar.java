...
public class Ventana_Personaje_Modificar extends JInternalFrame {
    ...
    private void initComponents() {
        ...
        jLabel12.setFont(new java.awt.Font("PMingLiU-ExtB", 1, 15)); // NOI18N
        jLabel12.setText("Datos a modificar (Codigo)");

        jTextField9.setColumns(5);
        jTextField9.setFont(new java.awt.Font("Copperplate Gothic Bold", 0, 14)); // NOI18N
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        if (JOptionPane.showConfirmDialog(this, "¿Modifcar el personaje?", "Seleccione una opción...", JOptionPane.YES_NO_CANCEL_OPTION, JOptionPane.QUESTION_MESSAGE) == 0) {
            ...
            retorno[7] = this.jTextField9.getText();
            try {
